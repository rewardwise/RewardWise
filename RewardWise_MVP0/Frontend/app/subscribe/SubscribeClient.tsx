...
function SubscribeInner({ isThankYou }: { isThankYou: boolean }) {
			...
			<div className="max-w-6xl mx-auto px-4 py-10 sm:py-14">
				{isThankYou && (
					<p
						...
						className="text-center text-emerald-800 text-sm mb-6 max-w-2xl mx-auto bg-emerald-50 border border-emerald-200/80 rounded-xl py-2 px-3"
					>
						Your first 2 months are free — applied automatically at checkout. You&apos;ll see $0.00 due today, then $3.99/mo after Jul 29.
					</p>
				)}
				{hasActiveDayPass && (
...
export default function SubscribeClient({ isThankYou }: { isThankYou: boolean }) {
	return (
		<Suspense
			fallback={
		...
		>
			<SubscribeInner isThankYou={isThankYou} />
		</Suspense>
	);
}
